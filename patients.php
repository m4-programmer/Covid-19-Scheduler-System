<!-- We check if the user has been authenticated to view this page. -->
<?php 

if (!isset($_SESSION['is_login'])){
		// redirect('?p=verification&msg=Please Authenticated yourself');
...
<div class="card card-outline card-primary" style="">
	<div class="card-header text-center" >
		<h3 class="text-bold" >List of Patients <button class="btn btn-sm btn-primary float-right" id="logout">Log Out</button> </h3>
				...
				<tbody>
					...
					?>
						...
						<tr>
							...
							<td><img src="<?php  echo isset($row['image']) ? $row['image'] : 'uploads/1624240500_avatar.png' ?>" style='width: 100%;' class='img img-responsive'></td>
...
<script>
	...
	$(document).ready(function(){
		$('.view_data').click(function(){
			uni_modal("Indiviual Details","view_details.php?code="+$(this).attr('data-id'))
		})
	...
	/*This script is runned when the logged out button is clicked*/
	$(function(){
		$('#logout').click(function(){
			<?php unset($_SESSION['is_login']);
				
			 ?>
			 location.href = 'http://localhost/scheduler/?p=verification';
		})
	})
</script>